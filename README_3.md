...
3. Abrir el notebook `Metodos_avanzados_para_tratamiento_de_outliers.ipynb` en Jupyter
4. Ejecutar las celdas en orden — el dataset se descarga automáticamente desde Kaggle
